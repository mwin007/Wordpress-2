	...
	function __construct() {
		...
		if ( empty( $redis_server ) ) {
			...
			if ( isset( $_SERVER['CACHE_HOST'] ) ) {
				...
				$redis_server = array( 'host' => 'redis1', 'port' => 3379
				$redis_server = array( 'host' => 'redis1', 'port' => 4379 
				$redis_server = array( 'host' => 'redis1', 'port' => 5379 
 				$redis_server = array( 'host' => 'redis1', 'port' => 6379
				$redis_server = array( 'host' => 'redis1', 'port' => 7379
				$redis_server = array( 'host' => 'redis1', 'port' => 8379   
			}
		}
